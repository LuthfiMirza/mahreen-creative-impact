  ...
  return (
    <section id="cta" className="relative overflow-hidden border-t border-gold/20 bg-surface px-6 py-28 transition-colors duration-700 sm:py-36">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.1fr_0.8fr] lg:items-center">
        ...
        <motion.div initial={prefersReduced ? false : { opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.35 }} transition={{ duration: 0.7, delay: 0.2 }} className="max-w-md lg:justify-self-end">
          <p className="text-lg leading-8 text-muted">
            Saya siap membawa kreativitas dan kemampuan teknis ke dalam tim Mahreen Indonesia.
          </p>
          <a href="mailto:luthfimirza2004@gmail.com?subject=Mahreen%20Indonesia%20Internship%20%E2%80%94%20Luthfi" className="button-shimmer mt-8 inline-flex min-h-12 items-center justify-center rounded-lg bg-gold px-6 py-3 font-semibold text-primary transition hover:-translate-y-1 hover:bg-[#d8ba82] focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-surface">
          ...
          <p className="mt-4 font-mono text-[0.68rem] uppercase tracking-[0.14em] text-muted">
            Submission · Mahreen Indonesia Internship Batch 1 · Web Developer
          </p>
        </motion.div>
      </div>
    </section>
